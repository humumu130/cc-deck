...
export const VERSION_NOTES: string[] = [
  "0.5.1：连接稳定性大幅提升——所有电脑持续保持在线，切换、回前台秒速恢复",
  "0.5.1：扫码配对全面修复，添加电脑更简单可靠",
  "0.5.1：全新连接管理——顶部一键切换电脑，连接编辑页焕新，状态一目了然",
  "0.5.1：安装包体积减半，下载安装更快",
  "0.5.1：界面细节全面打磨——状态实时可见、全面屏贴合、动效与通知更清晰",
  "0.5.1：新建会话支持跳过权限确认（可选），减少重复审批",
