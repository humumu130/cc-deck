...
export const VERSION_NOTES: string[] = [
  "0.5.1：连接稳定性大幅提升——所有设备持续保持在线，切换与回前台均秒速恢复",
  "0.5.1：扫码添加电脑体验重塑——扫一扫即连，自动选择局域网直连或云桥中转，跨网络同样稳定",
  "0.5.1：全新连接管理——手机上一键切换电脑，编辑页焕新，连接状态一目了然",
  "0.5.1：手机端安装包体积减半（38MB→16MB），下载安装更快",
  "0.5.1：界面细节全面打磨——状态实时可见、全面屏手势贴合、动效与通知更直观",
  "0.5.1：新建会话新增\"跳过权限确认\"开关（可选），告别重复审批",
  "消息发送大幅提速：点发送立刻送达电脑，不再有数秒等待",
  "电脑断网、重启后手机会话不再失联：点一下即可原地恢复继续对话",
  "连接状态更真实：显示已连接就是真的能用，断线恢复速度更快",
  "电脑端正常退出的会话自动从手机列表清除，不再堆积用不了的旧会话",
  "关于页可见版本通道（正式版/测试版/快照版），装的是哪个包一目了然",
];
