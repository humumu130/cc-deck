...
export const VERSION_NOTES: string[] = [
  "0.5.1：公司网络也能收到更新和下载安装包；APK 体积减半（38→16MB）",
  "0.5.1：扫码配对彻底修好——新配对的电脑不再卡在连接中",
  "0.5.1：连接管理重塑——顶栏一键切换电脑、编辑页重构、所有电脑保持在线",
  "0.5.1：状态栏实时显示 CLI 正在做的事；长任务不再误显示空闲",
  "0.5.1：新建会话可选跳过权限确认；常驻通知恢复彩点统计",
